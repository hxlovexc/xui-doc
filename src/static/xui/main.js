...
/* WEBPACK VAR INJECTION */}.call(__webpack_exports__, __webpack_require__(23), __webpack_require__(192)))
...
var xui = {
  ...
  xTabContent: _xTabContent2.default,
...
var _xInputBox = __webpack_require__(27);
...
var _xCheckboxGroup_xRadioGroup = __webpack_require__(28);
...
var _xCheckbox = __webpack_require__(29);
...
var _xRadio = __webpack_require__(30);
...
exports.default = {
  ...
  computed: {
    step: function step() {
      return this.$el.getBoundingClientRect().width / this.max;
    }
  },
  watch: {
    value: function value(_value) {
      if (this.disabled === false && this.sliderValue !== _value) {
  ...
  methods: {
    mousedown: function mousedown(event, type) {
    ...
    mousemove: function mousemove(event) {
      event.preventDefault();
      var left = event.clientX - this.startPosition + this.endPosition;
      var value = this.judgeVal(Math.round(left / this.step));
    ...
    mouseup: function mouseup() {
      var value = this.sliderValue = this.range ? [this.minVal, this.maxVal] : this.maxVal;
    ...
    judgeVal: function judgeVal(value) {
      if (this.range) {
        switch (this.handleType) {
          case 'min':
            var maxVal = this.maxPosition / this.step;
            if (value >= maxVal) {
              value = maxVal;
            }
            if (value <= this.min) {
            ...
            break;
          case 'max':
            var minVal = this.minPosition / this.step;
            if (value >= this.max) {
              value = this.max;
            }
            if (value <= minVal) {
    ...
    setMaxPosition: function setMaxPosition(value) {
      var left = value * this.step;
      this.maxVal = value;
      this.barWidth = left - this.minPosition;
      this.maxPosition = left;
    },
    setMinPosition: function setMinPosition(value) {
      var left = value * this.step;
      this.minVal = value;
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    ...
    style: ({
      'left': (_vm.minPosition + "px")
    }),
    on: {
      "mousedown": function($event) {
        _vm.mousedown($event, 'min')
      }
    }
  }) : _vm._e(), _vm._v(" "), _c('div', {
    staticClass: "x-slider-handle x-slider-max",
    style: ({
      'left': (_vm.maxPosition + "px")
    }),
    on: {
      "mousedown": function($event) {
        _vm.mousedown($event, 'max')
      }
    }
  }), _vm._v(" "), _c('div', {
      ...
      if (this.type === 'default') {
        this.$nextTick(function () {
          ...
          for (var i = 0; i < _this.contents.length; i++) {
            ...
            if (item.name === _this.value || i === _this.value) {
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-fd91afc6", Component.options)
  } else {
    hotAPI.reload("data-v-fd91afc6", Component.options)
  }
})()}
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-fd91afc6", module.exports)
  }
}
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  return _c('div', {
    staticClass: "x-progress x-progress",
    class: [
      'x-progress-' + _vm.status,
      'x-progress-' + _vm.size,
      {
        'x-radius': _vm.radius
      }
...
var _xTableHead = __webpack_require__(142);

var _xTableHead2 = _interopRequireDefault(_xTableHead);

var _xTableWidth = __webpack_require__(143);
...
if (false) {(function () {
  ...
  module.hot.accept()
  if (!module.hot.data) {
    hotAPI.createRecord("data-v-a38b04e0", Component.options)
  } else {
    hotAPI.reload("data-v-a38b04e0", Component.options)
  }
})()}
...
if (false) {
  module.hot.accept()
  if (module.hot.data) {
     require("vue-hot-reload-api").rerender("data-v-a38b04e0", module.exports)
  }
}
...
var _xDialog = __webpack_require__(193);
...
var _xToastr = __webpack_require__(197);
...
var _xToastrItem = __webpack_require__(199);
